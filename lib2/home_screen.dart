...
import 'package:chorewars2_13/Data/Task.dart';
import 'package:chorewars2_13/SquareCard.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Task> _getFilteredTasks() {
    ...
    if (selectedCategory == 'My Tasks') {
      ...
      List<Task> inProgressTasks = tasks.where((task) => !task.done).toList();
      inProgressTasks.sort((a, b) {
        int dateCompare = a.date.compareTo(b.date);
        if (dateCompare != 0) return dateCompare;

        // Sort by descending priority if same date
